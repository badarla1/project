...
app.post("/api/post",(req,res)=>{
    const {name,email,phn_num} = req.body;
...
app.put("/api/put/:id",(req,res)=>{
    ...
    db.query(sqlUpdate,[name,email,phn_num,id],(error,result)=>{
        if(error){
            console.log(error);
        }
        res.send(result);
...
// app.get("/",(req,res)=>{
//      const sqlInsert = "insert into contactdetails(name,email,phn_num) values ('John ','john@gmail.com','12341567')";
